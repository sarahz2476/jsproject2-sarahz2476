$.ajax({
    ...
    success: function(data) {
        ...
        var borough = prompt ("Input a New York borough (Make sure to Capitalize the first letters)."); // ask the user for a borough + user's answer is the value of the variable
      ...
      // this loop will go through the list and print out any council members' name with distric office in the borough the user asks for
       ...
       // In the json for these two council members, the borough object is formatted "borough1 and borough 2".
